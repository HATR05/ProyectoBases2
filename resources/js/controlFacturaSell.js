...
function insertProduct() {
	  ...
	  var producto_id = arrayDeCadenas[0];
	  valor_Unitario = arrayDeCadenas[1];
    if(valor != null){

	  var fila="<tr><td><div class=\"row_dataEditable\" edit_type=\"click\" col_name=\"fid_producto\">"+
	  producto_id+"</div></td>"+
	  "<td><div class=\"row_dataUneditable\" col_name=\"fproducto\">"+selected+"</div></td>"+
	  ...
	  //Botones
	  fila +="<td><span class=\"btn_delete\" > <a class=\"btn btn-link\"style=\"color: #ffc107\""+
