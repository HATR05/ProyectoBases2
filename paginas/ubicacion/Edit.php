...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE ubicacion SET barrio_id=%s, direccion=%s, codigo_postal=%s WHERE ubicacion_id=%s",
                       GetSQLValueString($_POST['barrio_id'], "int"),
                       GetSQLValueString($_POST['direccion'], "text"),
                       GetSQLValueString($_POST['codigo_postal'], "int"),
                       GetSQLValueString($_POST['ubicacion_id'], "int"));
...
$colname_ubi3 = "-1";
if (isset($_GET['ubicacion_id'])) {
  $colname_ubi3 = $_GET['ubicacion_id'];
}
mysql_select_db($database_connect_DB, $connect_DB);
$query_ubi3 = sprintf("SELECT * FROM ubicacion WHERE ubicacion_id = %s", GetSQLValueString($colname_ubi3, "int"));
$ubi3 = mysql_query($query_ubi3, $connect_DB) or die(mysql_error());
    ...
    <body>
        <div class="wrapper">
            ...
            <div id="content" class="background-page">
                ...
                <div class="contenido">
                    <h1 class="titleCreate">Editar Ubicacion.</h1>
                    <form>
                    </form>
                    <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                      <table align="center">
                        <tr valign="baseline">
                          <td nowrap align="right">Ubicacion_id:</td>
                          <td><?php echo $row_ubi3['ubicacion_id']; ?></td>
                        </tr>
                        <tr valign="baseline">
                          <td nowrap align="right">Barrio_id:</td>
                          <td><input type="text" name="barrio_id" value="<?php echo htmlentities($row_ubi3['barrio_id'], ENT_COMPAT, 'utf-8'); ?>" size="90" class="form-control"></td>
                        </tr>
                        <tr valign="baseline">
                          <td nowrap align="right">Direccion:</td>
                          <td><input type="text" name="direccion" value="<?php echo htmlentities($row_ubi3['direccion'], ENT_COMPAT, 'utf-8'); ?>" size="90" class="form-control"></td>
                        </tr>
                        <tr valign="baseline">
                          <td nowrap align="right">Codigo_postal:</td>
                          <td><input type="text" name="codigo_postal" value="<?php echo htmlentities($row_ubi3['codigo_postal'], ENT_COMPAT, 'utf-8'); ?>" size="90" class="form-control"></td>
                        </tr>
                        <tr valign="baseline">
                      ...
                      <input type="hidden" name="ubicacion_id" value="<?php echo $row_ubi3['ubicacion_id']; ?>">
                    </form>
                    <p>&nbsp;</p>
                </div>
