...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO ubicacion (direccion, codigo_postal, barrio_id) VALUES (%s, %s, %s)",
...
mysql_select_db($database_connect_DB, $connect_DB);
$query_ubi1 = "SELECT barrio_id FROM ubicacion";
$ubi1 = mysql_query($query_ubi1, $connect_DB) or die(mysql_error());
$row_ubi1 = mysql_fetch_assoc($ubi1);
$totalRows_ubi1 = mysql_num_rows($ubi1);
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        <div class="wrapper">
            ...
            <div id="content" class="background-page">
                ...
                <div class="contenido">
                    <h1 class="titleCreate">Agregar nueva Ubicacion.</h1>
                                       <form method="post" name="form1" action="<?php echo $editFormAction; ?>">
                      <table align="center">
                        <tr valign="baseline">
                          <td nowrap align="right">Direccion:</td>
                          <td><input type="text" name="direccion" value="" size="90" class="form-control"></td>
                        </tr>
                        <tr valign="baseline">
                          <td nowrap align="right">Codigo_postal:</td>
                          <td><input type="text" name="codigo_postal" value="" size="90" class="form-control"></td>
                        </tr>
                        <tr valign="baseline">
                          <td nowrap align="right">Barrio_id:</td>
                          <td><select name="barrio_id" class="form-control">
                            <?php
do {  
?>
                            <option value="<?php echo $row_ubi1['barrio_id']?>"><?php echo $row_ubi1['barrio_id']?></option>
                            <?php
} while ($row_ubi1 = mysql_fetch_assoc($ubi1));
  $rows = mysql_num_rows($ubi1);
  if($rows > 0) {
      mysql_data_seek($ubi1, 0);
	  $row_ubi1 = mysql_fetch_assoc($ubi1);
  }
?>
                          </select></td>
                      ...
                      <a class="btn btn-ambar" href="/ProyectoBases2/paginas/departamento/Create.php">Nuevo departamento</a> <a class="btn btn-ambar" href="/ProyectoBases2/paginas/ciudad/Create.php">Nueva Ciudad</a> <a class="btn btn-ambar" href="/ProyectoBases2/paginas/barrio/Create.php">Nuevo Barrio</a>
                      <p>
