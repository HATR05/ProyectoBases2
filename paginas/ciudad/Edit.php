...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE ciudad SET departamento_id=%s, nombre_ciudad=%s WHERE ciudad_id=%s",
...
if (isset($_GET['ciudad_id'])) {
  $colname_ciu3 = $_GET['ciudad_id'];
}
mysql_select_db($database_connect_DB, $connect_DB);
$query_ciu3 = sprintf("SELECT * FROM ciudad WHERE ciudad_id = %s", GetSQLValueString($colname_ciu3, "int"));
$ciu3 = mysql_query($query_ciu3, $connect_DB) or die(mysql_error());
$row_ciu3 = mysql_fetch_assoc($ciu3);
$totalRows_ciu3 = mysql_num_rows($ciu3);
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        <div class="wrapper">
            ...
            <div id="content" class="background-page">
                ...
                <div class="contenido">
                    <h1 class="titleCreate">Editar Ciudad.</h1>
             
                 
                  <table align="center">
                    <tr valign="baseline">
                      <td nowrap align="right">Ciudad_id:</td>
                      <td><?php echo $row_ciu3['ciudad_id']; ?></td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap align="right">Departamento_id:</td>
                      <td><input type="text" name="departamento_id" class="form-control" value="<?php echo htmlentities($row_ciu3['departamento_id'], ENT_COMPAT, 'utf-8'); ?>" size="85"></td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap align="right">Nombre_ciudad:</td>
                      <td><input type="text" name="nombre_ciudad" class="form-control" value="<?php echo htmlentities($row_ciu3['nombre_ciudad'], ENT_COMPAT, 'utf-8'); ?>" size="32"></td>
                    </tr>
                    <tr valign="baseline">
                      <td nowrap align="right">&nbsp;</td>
                      <td><div align="center">
                        <input type="submit" value="Guardar" class="btn btn-ambar">
                        <a class="btn btn-ambar" href="List.php">Mostrar Ciudades</a> <a class="btn btn-ambar" href="/ProyectoBases2/administrador.html">Inicio</a></div></td>
                    </tr>
                  </table>
              </div>
