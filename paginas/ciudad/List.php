                  ...
                  <thead class="thead-dark">
                    ...
                    <?php do { ?>
                      <tr>
                        ...
                        <td><?php echo $row_ciu3['departamento_id']; ?></td>
                        <td><?php echo $row_ciu3['nombre_ciudad']; ?></td>
                        <td><a class="btn-ambar" href="Edit.php? ciudad_id=<?php echo $row_ciu3['ciudad_id']; ?>">Modificar</a></td>
                      </tr>
                      <?php } while ($row_ciu3 = mysql_fetch_assoc($ciu3)); ?>
                  </table>
<p><a class="btn btn-ambar" href="Create.php">Crear nueva categoria</a>
