...
$query_bar2 = "SELECT * FROM barrio";
$bar2 = mysql_query($query_bar2, $connect_DB) or die(mysql_error());
$row_bar2 = mysql_fetch_assoc($bar2);
$totalRows_bar2 = mysql_num_rows($bar2);
            ...
            <div id="content" class="background-page">
                ...
                <div class="contenido">
                    ...
                    <table border="1" class="table table-light text-font">
                      ...
                      <?php do { ?>
                        <tr>
                          <td><?php echo $row_bar2['barrio_id']; ?></td>
                          <td><?php echo $row_bar2['ciudad_id']; ?></td>
                          <td><?php echo $row_bar2['nombre_barrio']; ?></td>
                          <td><a href="Edit.php? barrio_id=<?php echo $row_bar2['barrio_id']; ?>">Modificar</a></td>
                        </tr>
                        <?php } while ($row_bar2 = mysql_fetch_assoc($bar2)); ?>
                    </table>
