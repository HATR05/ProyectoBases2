            ...
            <div id="content" class="background-page">
                ...
                <div class="contenido">
                    ...
                    <div class="form-group row">
                        <label class="col-md-3 text-center" for="tipo_factura">
                            Tipo de factura a ingresar:
                        </label>
                        <div class="col-md  justify-content-rigth" id="checkBill">
                            <div class="custom-control custom-checkbox  custom-control-inline">
                                <input type="checkbox" class="custom-control-input" id="facturaventa" onchange = "check(this)" checked/>
                                <label class="custom-control-label" for="facturaventa">
                                    Factura de Venta.
                                </label>
                            </div>
                            <div class="custom-control custom-checkbox  custom-control-inline">
                                <input type="checkbox" class="custom-control-input" id="facturacompra" onchange = "check(this)"/>
                                <label class="custom-control-label" for="facturacompra">
                                    Factura de Compra.
                                </label>
                            </div>
                        </div>
