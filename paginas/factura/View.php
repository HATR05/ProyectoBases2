...
<html>
        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                        <a href="/ProyectoBases2/paginas/factura/List.php" class="nav-link">
                            <i class="fa fa-book">
                            </i>
                            Facturas
                        </a>
            ...
            <nav class="ocultar navbarSh navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a href="/ProyectoBases2/paginas/factura/Facturas.php" class="nav-link">
                                <i class="fa fa-book">
                                </i>
                                Facturas
                            </a>
            ...
            <div id="content" class="background-page">
                        ...
                        <div id = "imprimir">
                            ...
                            <div id="editar_Producto">
                                ...
                                <div class="form-group row" id="product" style="display: none">
                                    <label class="col-md-2" for="producto">
                                        Productos:
                                    </label>
                                    <div class="col-md-7 col-form-label">
                                        <select id="producto" class="browser-default custom-select" onchange="insertProduct()" disabled>
                                            <?php $consultaProducto = mysqli_query($link, "SELECT producto_id, nombre, valor_unidad FROM producto;"); echo "   <option value=\"null\"> -------------------   </option> "; while ($row = mysqli_fetch_array($consultaProducto)) { echo "   <option value=\"" . utf8_encode($row['producto_id']) . "--" . utf8_encode($row['valor_unidad']) . "\"> " . utf8_encode($row['nombre']) . "   </option> "; } ?>
                                        </select>
                                    </div>
                                    <a class="col-md-2 col-form-label" href="/ProyectoBases2/paginas/producto/Create.php" target="_blank" style="color: #ffc107" onmousemove="underline(this)" onmouseout="blankunderline(this)">
                ...
                <a class="btn btn-ambar" id="edit" onclick="editarFact()">
                    Editar
                </a>
    ...
    <script src="/ProyectoBases2/resources/js/controlFactura.js"></script>
