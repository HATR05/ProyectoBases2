        ...
        <div class="wrapper">
            ...
            <nav class="ocultar navbarSh navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item">
                            <a href="paginas/factura/Factura.php" class="nav-link"><i class="fa fa-book"></i> Facturas </a>
                        </li>
                        <li class="nav-item">
                            <a data-toggle="collapse" href="#settings" role="button" aria-expanded="false" aria-controls="settings" class="nav-link"><i class="fa fa-support"></i> Funciones Base </a>
                        </li>
            ...
            <div id="content" class="background-page">
                ...
                <div class="contenido">
                    ...
                    <h1 class="titleCreate">Agregar nueva factura de compra.</h1>
                    <br>
                    ...
                    <form>
                        <div class="form-group row justify-content-center">
                            <label class="col-md-2 " for="nombre_empleado">Empleado: </label>
                            <div class="col-md-7">
                            ...
                            <a class="col-md-2 " href="/ProyectoBases2/paginas/empleado/Create.php" target="_blank" style="color: #ffc107"onmousemove="underline(this)" onmouseout="blankunderline(this)">Crear un nuevo empleado.</a>

                            <p>

                            </p>
                            <label class="col-md-2" for="nombre_proveedor">Proveedor: </label>
                            <div class="col-md-7 " col-form-label>
                              <select type="text" id="proveedor" class="browser-default custom-select" >
                                <option value="null">-------------------</option>;
                                <?php
