...
<html>
    ...
    <body>
        <div class="wrapper">
            ...
            <div id="content" class="background-page">
                ...
                <div class="contenido">
                    ...
                    <h1 class="titleCreate">Agregar nueva factura.</h1>
                    <br>
                    ...
                    <form>
                        <div class="form-group row justify-content-center">
                            <label class="col-md-2 " for="nombre_empleado">Empleado a cargo: </label>
                            <div class="col-md-7">
                              <select id="empleado_id" class="browser-default custom-select" >
                                <?php
                                      $consultaEmpleado=mysqli_query($link,"SELECT CONCAT(nombre,' ',apellido) AS nombre FROM empleado WHERE cargo_id =(SELECT cargo_id FROM cargo WHERE nombre != 'Vendedor');");
                            ...
                            <label class="col-md-2" for="nombre_cliente">Proveedor: </label>
                            <div class="col-md-7 " col-form-label>
                              <select id="cliente" class="browser-default custom-select" >
                                <?php
                                      $consultaEmpleado=mysqli_query($link,"SELECT nombre,nit from proveedor;");
                                      while($row= mysqli_fetch_array($consultaEmpleado)){
                                          echo "<option value=".utf8_encode($row['nit']).">".utf8_encode($row['nombre'])."</option>";
                                      }
                                  ?>
                              </select>
                            </div>
                        ...
                        <div class="card-body d-flex justify-content-between align-items-center">
                            ...
                            <input class="col-md-2 " type="text" id="saldo" value=""><br>
                            <label class="col-md-1" id="Subtotallabel">Subtotal </label>
                            <input class="col-md-2 " type="text" id="subtotal" value=" " readonly><br>
                            <label class="col-md-1" id="Totallabel">Total </label>
                            <input class="col-md-2" type="text" id="total" value="" readonly><br>
                        </div>
                        <label class="align-items-center" id="mensaje" value="  "style="color: green"></label><br>
                        <!-- Botón de guardar -->
                        <button id="save" class="btn btn-ambar" onclick="keepData()">Guardar Factura</button>
                        <!-- Botón de mostrar todas las categorías -->
                        <button id="mostrar" class="btn btn-ambar" href="/ProyectoBases2/List.php">Mostrar Facturas</button>
                        <!-- Botón de inicio -->
      ...
      <!-- Bootstrap core JavaScript-->
        ...
        <script type="text/javascript" src="/ProyectoBases2/resources/js/controlFacturaBuy.js"></script>
    </body>
</html>